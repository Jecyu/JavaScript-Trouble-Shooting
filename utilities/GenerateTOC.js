 ...
 * 同样我们为不同层级的目录标题定义不同的样式。<h1>标签生成的标题 className 为“TOCLevel1”，
 * <h2>标签生成的标题 className 为“TOCLevel2”，以此类推
 * 段编号的样式为"TOCSectNum"
 * 完整的CSS样式代码如下:
...
(function() {
  ...
  for (var h = 0; h < headings.length; h++) {
    ...
    // 现在将所有标题级别的章节号组合产生一个章节号，如 2.3.1
